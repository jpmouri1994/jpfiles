					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "firstprogram",
									"targetURL": "#firstprogram-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"firstprogram-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.firstprogram.firstprogram",
									"url": sap.ui.require.toUrl("com/firstprogram/firstprogram")
								}
							}
						}
					}
